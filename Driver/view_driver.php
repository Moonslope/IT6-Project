        ...
        <div class="row pt-3">
            ...
            <div class="col col-9">
                <div class="card shadow">
                    <div class="card-body">
                        <h1 class="card-title fs-3 mb-3 text-center">DRIVER | LISTS</h1>
                                            ...
                                            <ul class="list-group mb-1">
                                                <li class="list-group-item d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <span><?php echo '<strong>Name   : </strong>' . $roww['driver_fname'] . ' ' . $roww['driver_lname'] ?></span> <br>
                                                            <span><?php echo '<strong>Address   : </strong> ' . $roww['driver_address'] ?></span><br>
                                                            <span><?php echo '<strong>Contact Number   : </strong>' . $roww['driver_contactNum'] ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="group-btn">
                                                        <a href="../Driver/edit_driver.php?id=<?php echo $roww['id'] ?>" class="btn"><i class="btn btn-outline-success bi bi-pencil-square"></i></a>
                                                        <a href="../Operations/op_delete_driver.php?id=<?php echo $roww['id'] ?>" class="btn"><i class="btn btn-outline-danger bi bi-trash"></i></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
