...
$id = $_GET['id'];
$sqll = "SELECT * FROM driver WHERE id=" . $id;
$resultt = $conn->query($sqll);
$roww = $resultt->fetch_assoc();
$title = 'Cashier Lists | ' . $roww['driver_fname'] . ' ' . $roww['driver_lname'];
                                        ...
                                        <form action="../Operations//op_edit_driver.php" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <input type="text" id="driver_fname" name="driver_fname" value="<?php echo $roww['driver_fname'] ?>" class="form-control border-dark">
                                                </div>

                                                <div class="col">
                                                    <label for="driver_lname" class="fw-semibold mb-3">Last Name</label>
                                                    <input type="text" id="driver_lname" name="driver_lname" value="<?php echo $roww['driver_lname'] ?>" class="form-control border-dark">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-2">
                                                <div class="col">
                                                    ...
                                                    <input type="text" id="driver_address" name="driver_address" value="<?php echo $roww['driver_address'] ?>" class="form-control border-dark">
                                                </div>

                                                <div class="col">
                                                    <label for="cashier_contactNum" class="fw-semibold mb-3">Contact Number</label>
                                                    <input type="text" id="driver_contactNum" name="driver_contactNum" value="<?php echo $roww['driver_contactNum'] ?>" class="form-control border-dark">
                                                </div>
                                            </div>
